...
<head>
	<!-- Basic Page Info -->
	<meta charset="utf-8">
	<title>scimassurances</title>

	<!-- Site favicon -->
	<!-- <link rel="apple-touch-icon" sizes="180x180" href="{{asset('vendors/images/apple-touch-icon.png')}}"> -->
	<!-- <link rel="icon" type="image/png" sizes="32x32" href="{{asset('vendors/images/favicon-32x32.png')}}">
	<link rel="icon" type="image/png" sizes="16x16" href="{{asset('vendors/images/favicon-16x16.png')}}"> -->
	<link rel="icon" type="image/png" href="{{url('styles/img/LOGO1.jpg')}}"/>
...
<body>
	<div class="pre-loader">
		<div class="pre-loader-box">
			<div class="loader-logo"><img src="{{url('styles/img/LOGO1.jpg')}}" class="logo logo-display m-top-10" alt="IMG" ></div>
	...
	<div class="header">
		...
		<div class="header-right">
			...
			<div class="user-info-dropdown">
                ...
                @csrf
                <button><i class="dw dw-logout"></i>Déconnexion</button>
              </form>
					</div>
				</div>
			</div>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-edit2"></span><span class="mtext">actualites</span>
						</a>
						<ul class="submenu">
							<li><a href="{{route('actualites.index')}}">Liste des actualites</a></li>
							<li><a href="{{route('actualites.create')}}">ajouter des actualites</a></li>
						</ul>
					</li>
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
