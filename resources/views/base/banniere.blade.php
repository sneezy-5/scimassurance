    ...
    <div class="container-fluid px-0 mb-5">
        ...
        <div id="header-carousel" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <div class="imgbanner1 w-100"></div>
                ...
                <div class="carousel-item">
                    <div class="imgbanner2 w-100"></div>
        ...
        <marquee behavior="ff" direction="left" class="bg-danger text-light">Profitez desormais de <strong class="text-dark">50% de reduction</strong> sur nos produits et services</marquee>
    </div>
    <!-- Carousel End -->