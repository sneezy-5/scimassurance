        ...
        <div class="row g-5">
            ...
            <div class="col-md-6 col-xl-3 wow fadeIn" data-wow-delay="0.7s">
                <div class="text-center border p-5">
                    ...
                    <h1 class="display-2 text-primary mb-0" data-toggle="counter-up">25</h1>
                    <span class="fs-5 fw-semi-bold text-white titrepkw">Projets et plus</span>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.5s">
                    ...
                    <p class="mb-4">Si nos clients nous renouvellent leur confiance,c'est parce que nous trouvons pour eux
                        les solutions les plus performantes et les plus innovantes, en associant la technicité à la relation humaine.
                    </p>
                    <div class="row gy-4">
                        <div class="col-12">
                            <div class="d-flex">
    ...
    <div class="container-xxl py-5">
                    ...
                    <div class="service-item">
                        ...
                        <div class="service-detail">
                            <div class="service-title">
                                <hr class="w-25">
                                <h3 class="mb-0">Mulltirisque Professionnel</h3>
        ...
        <div class="container mt-5">
            ...
            <div class="row gy-5 gx-4">
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.1s">
                    <div class="service-item">
                        ...
                        <div class="service-detail">
                            <div class="service-title">
                                <hr class="w-25">
                                <h3 class="mb-0">Mulltirisque Habitation</h3>
                                <small>Votre logement, c'est important</small>
                                <hr class="w-25">
                            </div>
                            <div class="service-text">
                                <p class="text-white mb-0">L'assurance mulltirisque habitation répond au plus près à vos attentes.
                ...
                <div class="col-md-6 col-lg-4 wow fadeInUp" data-wow-delay="0.3s">
                    <div class="service-item">
                        <img class="img-fluid" src="{{asset('images/fly.jpg')}}" alt="">
                        <div class="service-img">
                            <img class="img-fluid" src="{{asset('images/fly.jpg')}}" alt="">
                        </div>
                        <div class="service-detail">
